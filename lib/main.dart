                  ...
                  child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text(
                              'noTelpon : ${pendaftaranList[index].noTelpon!}'),
                          Text(
                              'jenisKelamin : ${pendaftaranList[index].jenisKelamin!}'),
                          Text('bahasa : ${pendaftaranList[index].bahasa!}'),
                          Text('agama : ${pendaftaranList[index].agama!}'),
                          Text(
                              'tanggalDaftar : ${pendaftaranList[index].tanggalDaftar!}'),
                          Text(
                              'jamDaftar : ${pendaftaranList[index].jamDaftar!}'),
                        ],
                      )),
                ),
              );
